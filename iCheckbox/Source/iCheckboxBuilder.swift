...
public final class iCheckboxBuilder: NSObject {
    ...
    private var checkboxBuilderConfig: iCheckboxBuilderConfig
    ...
    public init(withCanvas canvas: UIView, andConfig config: iCheckboxBuilderConfig) {
        self.canvas = canvas
    ...
    public func addCheckboxes(withStates states: [iCheckboxState]) {
    ...
    private func configureHeaderLabel() {
        ...
        if let title = checkboxBuilderConfig.headerTitle {
            headerLabel.textColor = checkboxBuilderConfig.headerTitleColor
